...
* Resource viewer is a graph containing nodes representing interactions between objects in a Kubernetes cluster. Nodes provide additional information about the status as well as additional components used to describe the object.
