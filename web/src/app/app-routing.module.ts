...
import { OlympusStacksComponent } from './modules/olympus-stacks/components/olympus-stacks/olympus-stacks.component';
import { OverviewComponent } from './modules/overview/overview.component';
import { PageNotFoundComponent } from './components/page-not-found/page-not-found.component';

export const appRoutes: Routes = [
  { path: 'content', children: [{ path: '**', component: OverviewComponent }] },
  { path: 'olympus-stacks', component: OlympusStacksComponent },
