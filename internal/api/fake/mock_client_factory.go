...
// Source: github.com/vmware-tanzu/octant/internal/api (interfaces: StreamingClientFactory)
...
func (m *MockStreamingClientFactory) NewConnection(arg0 uuid.UUID, arg1 http.ResponseWriter, arg2 *http.Request, arg3 *api.StreamingConnectionManager, arg4 config.Dash) (api.StreamingClient, context.CancelFunc, error) {
	m.ctrl.T.Helper()
...
func (m *MockStreamingClientFactory) NewTemporaryConnection(arg0 uuid.UUID, arg1 http.ResponseWriter, arg2 *http.Request, arg3 *api.StreamingConnectionManager) (api.StreamingClient, context.CancelFunc, error) {
	m.ctrl.T.Helper()
