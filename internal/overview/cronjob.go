...
func (rss *CronJobSummary) Content(ctx context.Context, object runtime.Object, c cache.Cache) ([]content.Content, error) {
...
func (rss *CronJobSummary) summary(cronJob *batchv1beta1.CronJob, c cache.Cache) ([]content.Content, error) {
...
func (j *CronJobJobs) Content(ctx context.Context, object runtime.Object, c cache.Cache) ([]content.Content, error) {
	cronJob, err := retrieveCronJob(object)
	if err != nil {
		return nil, err
	}
...
func (j *CronJobJobs) jobs(cronJob *batchv1beta1.CronJob, c cache.Cache) ([]content.Content, error) {
	jobs, err := listJobs(cronJob.GetNamespace(), cronJob.GetUID(), c)
	if err != nil {
		return nil, err
	}
