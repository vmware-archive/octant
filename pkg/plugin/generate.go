...
//go:generate mockgen -destination=./fake/fakes.go -package=fake github.com/vmware/octant/pkg/plugin Runners,ManagerStore,ClientFactory,ModuleService,Service,Broker
