...
//go:generate mockgen -source=dashboard/dashboard_grpc.pb.go -destination=./fake/mock_plugin_client.go -package=fake github.com/vmware-tanzu/octant/pkg/plugin/dashboard PluginClient
