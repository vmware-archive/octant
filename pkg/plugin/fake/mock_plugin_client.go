...
// Source: dashboard/dashboard_grpc.pb.go
...
// mustEmbedUnimplementedPluginServer mocks base method.
func (m *MockPluginServer) mustEmbedUnimplementedPluginServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedPluginServer")
}

// mustEmbedUnimplementedPluginServer indicates an expected call of mustEmbedUnimplementedPluginServer.
func (mr *MockPluginServerMockRecorder) mustEmbedUnimplementedPluginServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedPluginServer", reflect.TypeOf((*MockPluginServer)(nil).mustEmbedUnimplementedPluginServer))
}

// MockUnsafePluginServer is a mock of UnsafePluginServer interface.
type MockUnsafePluginServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafePluginServerMockRecorder
}
...
func NewMockUnsafePluginServer(ctrl *gomock.Controller) *MockUnsafePluginServer {
	mock := &MockUnsafePluginServer{ctrl: ctrl}
	mock.recorder = &MockUnsafePluginServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafePluginServer) EXPECT() *MockUnsafePluginServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedPluginServer mocks base method.
func (m *MockUnsafePluginServer) mustEmbedUnimplementedPluginServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedPluginServer")
}

// mustEmbedUnimplementedPluginServer indicates an expected call of mustEmbedUnimplementedPluginServer.
func (mr *MockUnsafePluginServerMockRecorder) mustEmbedUnimplementedPluginServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedPluginServer", reflect.TypeOf((*MockUnsafePluginServer)(nil).mustEmbedUnimplementedPluginServer))
}
